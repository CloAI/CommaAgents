...
- [delete_file](/docs/core/tools/built-in/file-io/delete_file) · [apply_patch](/docs/core/tools/built-in/file-io/apply_patch) — every successful operation is journaled.
