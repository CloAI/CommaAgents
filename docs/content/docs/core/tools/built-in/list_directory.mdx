...
- [read_file](/docs/core/tools/built-in/read_file) — read a single file.
- [search_files](/docs/core/tools/built-in/search_files) — search across many files when you don't know the exact name.
