...
- [write_file](/docs/core/tools/built-in/file-io/write_file) — overwrite an existing file by sha256.
- [edit_file](/docs/core/tools/built-in/file-io/edit_file) — change a region of an existing file.
