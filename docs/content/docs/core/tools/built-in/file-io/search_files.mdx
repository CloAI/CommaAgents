...
- [list_directory](/docs/core/tools/built-in/file-io/list_directory) — enumerate a single directory when you don't need a search.
- [read_file](/docs/core/tools/built-in/file-io/read_file) — read the matched file once you've located it.
