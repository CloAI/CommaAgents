...
- [list_directory](/docs/core/tools/built-in/file-io/list_directory) — enumerate a directory instead of reading a single file.
- [Stale file protocol](/docs/core/tools/built-in/file-io) — how `sha256` flows from read into write/edit/apply_patch.
