...
- [delete_file](/docs/core/tools/built-in/file-io/delete_file) — when you want to remove the file instead of relocate it.
- [apply_patch](/docs/core/tools/built-in/file-io/apply_patch) — for multi-file moves combined with edits.
