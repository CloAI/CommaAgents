...
- [write_file](/docs/core/tools/built-in/write_file) — when the whole file changes.
- [apply_patch](/docs/core/tools/built-in/apply_patch) — for multi-file diffs and renames.
- [Stale file protocol](/docs/core/tools/stale-file-protocol) — the full sha256 lifecycle.
