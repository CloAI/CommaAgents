---
title: CLI
description: Command-line interface for starting, stopping, and checking daemon status.
---

# CLI

The `comma-agents-daemon` binary provides three subcommands for managing the daemon process: `start`, `stop`, and `status`.
...
Daemon is running (PID: 12345)
  Config: /home/user/.config/comma-agents/daemon.toml
