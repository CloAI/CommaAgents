...
| [`prepare_run`](/docs/daemon/protocol/strategy-execution) | `run_prepared` | Request/Reply |
| [`start_run`](/docs/daemon/protocol/strategy-execution) | `strategy_started`, `strategy_completed`, `strategy_error` | Fire-and-forget + async events |
| [`continue_run`](/docs/daemon/protocol/strategy-execution) | `strategy_started`, `strategy_completed`, `strategy_error` | Fire-and-forget + async events |
| [`stop_run`](/docs/daemon/protocol/strategy-execution) | `strategy_error` (code: `CANCELLED`) | Fire-and-forget |
| [`list_strategies`](/docs/daemon/protocol/list-and-subscribe) | `strategy_list` | Request/Reply |
| [`list_providers`](/docs/daemon/protocol/list-providers) | `provider_list` | Request/Reply |
| [`get_available_models`](/docs/daemon/protocol/get-available-models) | `available_models` | Request/Reply |
...
| [`steer_run`](/docs/daemon/protocol/steering) | `steer_queued` (or `error` if not steerable) | Fire-and-forget + async event |
