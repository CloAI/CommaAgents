...
The picker shows a "Choose a strategy:" heading followed by the `SelectInput` list. Each item displays the label and description concatenated. The component uses arrow keys for navigation and Enter to select.
