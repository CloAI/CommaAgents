...
export const MODEL_CATALOG: Readonly<Record<string, ModelMetadata>> = {
  ...
  // Anthropic
  "anthropic/claude-sonnet-4-5": { contextWindow: 200_000, maxOutputTokens: 8_192 },
  "anthropic/claude-opus-4": { contextWindow: 200_000, maxOutputTokens: 8_192 },
  "anthropic/claude-3-5-haiku-latest": { contextWindow: 200_000, maxOutputTokens: 8_192 },
  "anthropic/claude-3-5-sonnet-latest": { contextWindow: 200_000, maxOutputTokens: 8_192 },
  "anthropic/claude-3-opus-latest": { contextWindow: 200_000, maxOutputTokens: 4_096 },
  ...
  "google/gemini-1.5-flash": { contextWindow: 1_048_576, maxOutputTokens: 8_192 },

  // DeepSeek
  "deepseek/deepseek-chat": { contextWindow: 64_000, maxOutputTokens: 8_192 },
  "deepseek/deepseek-reasoner": { contextWindow: 64_000, maxOutputTokens: 8_192 },

  // Groq
  "groq/llama-3.3-70b-versatile": { contextWindow: 128_000, maxOutputTokens: 32_768 },
  "groq/llama-3.1-8b-instant": { contextWindow: 128_000, maxOutputTokens: 8_192 },
  "groq/mixtral-8x7b-32768": { contextWindow: 32_768, maxOutputTokens: 32_768 },

  // Mistral
  "mistral/mistral-large-latest": { contextWindow: 128_000, maxOutputTokens: 8_192 },
  "mistral/mistral-small-latest": { contextWindow: 128_000, maxOutputTokens: 8_192 },
  "mistral/codestral-latest": { contextWindow: 256_000, maxOutputTokens: 8_192 },
  ...
  "github-copilot/claude-sonnet-4": { contextWindow: 200_000, maxOutputTokens: 8_192 },
} as const;
