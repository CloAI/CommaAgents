...
import type { AgentHooks, CycleHooks, FlowHooks, ToolHooks } from "../hooks/types";
import { createSimpleMockModel, createToolCallingMockModel } from "./helpers/mock-model";
import { createEchoTool, createRecordingTool } from "./helpers/test-tools";
...
describe("E2E: Flow Composition", () => {
  ...
  describe("error propagation", () => {
    it("should wrap step errors in FlowExecutionError", async () => {
      ...
      const failingAgent: import("../agents/types").Agent = {
        name: "failing-agent",
        async call(): Promise<import("../agents/types").AgentCallResult> {
    ...
    it("should stop sequential flow at the failing step (not continue)", async () => {
      ...
      const agentA: import("../agents/types").Agent = {
        name: "agent-a",
        async call() {
      ...
      const agentB: import("../agents/types").Agent = {
        name: "agent-b",
        async call() {
      ...
      const agentC: import("../agents/types").Agent = {
        name: "agent-c",
        async call() {
