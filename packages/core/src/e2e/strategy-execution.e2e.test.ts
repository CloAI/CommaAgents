...
import { exportStrategy } from "../strategy/exporter";
import type { LoadStrategyOptions, ProviderFactory } from "../strategy/loader";
import { loadStrategyFromString } from "../strategy/loader";
...
describe("E2E: Strategy Execution", () => {
  ...
  describe("strategy with tool-calling agent", () => {
    it("should load and execute a strategy with a custom tool", async () => {
      ...
      const { defineTool } = await import("../tools/define/define-tool");
